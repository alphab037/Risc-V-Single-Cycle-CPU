module datapath(
    ...
    output [31:0] x1, x2,x3, Mux1, Mux2, Mux3, Mux4,Mux5
);

rv32i_cpu uut1(.CLK(clk),.reset(reset),.Mux4(Mux5),.PC(PC));
...
mux2to1 uut11(.a(PC+4),.b((imm_ext)+PC),.s1(btaken),.o(Mux3));
mux2to1 uut12(.a(Mux3),.b((imm_ext)+PC),.s1(jal),.o(Mux4));
mux2to1 uut13(.a(Mux4),.b(imm_ext+rs1_data),.s1(jalr),.o(Mux5));
